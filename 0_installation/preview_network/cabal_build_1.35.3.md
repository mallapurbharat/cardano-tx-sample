...
##### OPTION 1 - Installing the custom libsodium
...
##### OPTION 2 Using the ported `c` code
...
**Note:** As a worst-case scenario, in case the node doesn't seem to parse the existing chain db, 
