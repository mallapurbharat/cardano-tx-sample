Refer https://github.com/input-output-hk/cardano-ledger/blob/master/eras/alonzo/test-suite/cddl-files/alonzo.cddl for alonzo CBOR CDDL
...
Identifier of previous transaction `T` is a hash of `T`. It is BLAKE2b-256 hash,
...
Source: https://raw.githubusercontent.com/input-output-hk/cardano-sl/develop/docs/tx/binary-format.md
